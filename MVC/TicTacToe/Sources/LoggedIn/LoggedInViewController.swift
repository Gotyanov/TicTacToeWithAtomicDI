...
class LoggedInViewController: UIViewController, ScoreSheetListener {
    ...
    private let gameBuilder: () -> UIViewController
    private let scoreStream: ScoreStream
    private var gameDisposable: Disposable?
    private let scoreSheetBuilder: () -> UIViewController

    init(gameBuilder: @escaping () -> UIViewController, scoreStream: ScoreStream, scoreSheetBuilder: @escaping () -> UIViewController) {
    ...
    private func didTapScoreButton() {
        if let scoreSheetVC = scoreSheetBuilder() as? ScoreSheetViewController {
    ...
    private func didTapGameButton() {
        let viewController = gameBuilder()
